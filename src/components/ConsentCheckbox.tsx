    ...
    <div>
      <label htmlFor={id} className="flex cursor-pointer items-start gap-2.5 text-xs leading-relaxed text-brand-500">
        ...
        <span>
          ...
          email, адрес, комментарий к заказу) для оформления и выполнения
          заказа, в том числе на их передачу в Telegram за пределы Республики
          Беларусь, о рисках которой я проинформирован, — на условиях{" "}
          <Link
            href={PRIVACY_URL}
            target="_blank"
